...
class BusinessAdmin(admin.ModelAdmin):
    list_display = ('name', 'contact_no', 'start_date', 'end_date', 'reference_no', 'report_ready', 'influencer')
    list_filter = ('start_date', 'end_date', 'influencer')
    search_fields = ('name', 'contact_no', 'reference_no')
    ordering = ('-start_date',)
    fields = ('name', 'contact_no', 'start_date', 'end_date', 'reference_no', 'report_ready', 'influencer')
